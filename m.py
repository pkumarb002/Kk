...
OWNER_ID = "5268655042"
bot = telebot.TeleBot('8147245129:AAEsjIwvtkhRVLo1YY1LjP5SvMi-WmKPfdE')
...
def handle_bgmi(message):
    ...
    if len(current_active) >= 2:
        bot.reply_to(message, "🚨 Maximum of 2 concurrent attacks allowed. Please wait for the current attack to finish before launching a new one.")
        return
    ...
    msg = bot.send_animation(
        message.chat.id,
        animation="https://media2.giphy.com/media/Yv0y9SWaAH5h8zSi8u/giphy.gif?cid=6c09b952yq460tmenhb4dgs70q7dwsj07gd1p9uwt57et1a3&ep=v1_internal_gif_by_id&rid=giphy.gif&ct=g/giphy.gif",
        caption=f"""
⚡️🔥 𝐀𝐓𝐓𝐀𝐂𝐊 𝐃𝐄𝐏𝐋𝐎𝐘𝐄𝐃 🔥⚡️
